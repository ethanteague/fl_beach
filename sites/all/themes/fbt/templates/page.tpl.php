...
?>
<?php if ($logo): ?>
<div id="logo-container"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="header__logo" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" class="header__logo-image" /></a></div>
<?php endif; ?>
  <div id="above-top">
  <div id="at-wrap">
  <div id="at-left">
...
<div id="bottom-page-wrap">
  ...
  <div id="bottom-page">
   <a class="reg" href="user/register">REGISTER YOUR BUSINESS ON FLORIDA BEACH TRAILS!</a> | ©Florida Beach Trails 2012
  </div>
